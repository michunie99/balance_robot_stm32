...
#ifndef INC_ICM20948_I2C_H_
#define INC_ICM20948_I2C_H_

#include "stm32f4xx_hal.h" // Needed for I2C

/* DEFINES */
#define IMC20948_I2C_ADDR			(0x69 << 1) // if AD0 is 0

#define IMC20948_DEVICE_ID 			0xEA


/* IMC20948 registers (p.36) */
...
typedef struct {
	...
	/* Acceleration data (X,Y,Z) in G */
	float acc_g[3];

	/* Gyro data (X,Y,Z) in dps */
	float gyro_dps[3];
